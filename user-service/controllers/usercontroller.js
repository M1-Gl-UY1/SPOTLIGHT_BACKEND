...
const adminCreateUser = asyncHandler(async (req, res) => {
    const { firstName, lastName, email, phone, password, country, role } = req.body;
...
const logout = asyncHandler(async (req, res) => {
    ...
    if (req.cookies?.jwt) {
        user = await User.findOne({ where: { refreshToken: { [Op.contains]: [token] } } });
    } else {
        try {
...
module.exports = {
    ...
    getUsersProfile, updateUserProfile, 
     postAvatar, deleteAvatar,
     getAvatar, getUser, AdminUpdateUser, searchProfile, getUserByPhone, EditRole, adminCreateUser
     };